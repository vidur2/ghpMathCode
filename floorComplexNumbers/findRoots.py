...
def adjustPoint(pixelValue: tuple, gray):
	...
	return complex(((pixelWidth - width/2)/width) * 8, ((pixelHeight - height/2)/height) * 8)
...
def kill_pixels(second, minLoc: tuple):
	...
	second[minLoc[1]][minLoc[0] - 1] = 255
	second[minLoc[1] - 1][minLoc[0] - 1] = 255
	if second[minLoc[1]][minLoc[0]] < 10:
